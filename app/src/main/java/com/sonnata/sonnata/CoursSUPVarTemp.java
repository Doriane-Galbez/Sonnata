...
public class CoursSUPVarTemp extends AppCompatActivity {
    Button boutRetour = null;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cours_supvar_temp);
    ...
    private View.OnClickListener boutRetourListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            Intent menu = new Intent(CoursSUPVarTemp.this, MainActivity.class);
            startActivity(menu);
            finish();
        }
    };
