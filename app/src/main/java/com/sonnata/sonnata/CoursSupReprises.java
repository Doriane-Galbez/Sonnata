...
public class CoursSupReprises extends AppCompatActivity {
    Button boutRetour = null;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cours_sup_reprises);
    ...
    private View.OnClickListener boutRetourListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            Intent menu = new Intent(CoursSupReprises.this, MainActivity.class);
            startActivity(menu);
            finish();
        }
    };
